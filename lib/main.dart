...
class _TimeMachineState extends State<TimeMachine>
  ...
  late AnimationController _repeatingAnimationShort;
  late AnimationController _repeatingAnimationLong;
  late AnimationController _loopingAnimationShort;
  late AnimationController _loopingAnimationLong;
...
class TimeStopper extends StatelessWidget {
  ...
  const TimeStopper({ required this.controllers}) ;
...
class FlingButton extends StatelessWidget {
  ...
  const FlingButton({ required this.controllers}) ;
...
class GalaxyFitz extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Image.asset('assets/fitx.png');
  }
}